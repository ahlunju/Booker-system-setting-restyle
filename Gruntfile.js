    ...
    sass: {                                       // Task
      dev: {                                      // Target
        ...
        files: {                                  // Dictionary of files
          '../systemsettings.css': 'scss/styles.scss',   // 'destination': 'source'
          //'../ie.css': 'scss/ie.scss'//,
          '../defaulttheme.css':'scss/themes/defaulttheme.scss'
        }
      },
      prod: {                                     // Target
        options: {                                // Target options
        ...
        files: {                                  // Dictionary of files
          '../systemsettings.min.css': 'scss/styles.scss',   // 'destination': 'source'
          //'../ie.css': 'scss/ie.scss'//,
          'css/themes/defaulttheme.css':'scss/themes/defaulttheme.scss'
        }
      }
    },
